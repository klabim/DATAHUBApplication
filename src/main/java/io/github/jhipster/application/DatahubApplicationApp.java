...
public class DatahubApplicationApp {

    private static final Logger log = LoggerFactory.getLogger(DatahubApplicationApp.class);

    private final Environment env;

    public DatahubApplicationApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes DATAHUBApplication.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(DatahubApplicationApp.class);
